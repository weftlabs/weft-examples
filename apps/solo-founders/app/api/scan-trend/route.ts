...
import { PaidFetchError, scanTrend } from "../../../lib/founder";
import { httpErrorStatus, isAllowedOrigin } from "../analyze-founder/route";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await scanTrend(body.requestId, new WeftClient({ apiKey }));
